...
public class MemberLogin implements Command {
	...
	public String run(HttpServletRequest request, HttpServletResponse response) {
		...
		vo.setId(request.getParameter("id")); // /member/memberlogindFrom -> form 에 있는 이름을 가져온다 
		vo.setPassword(request.getParameter("password")); // /member/memberlogindFrom -> form 에 있는 이름을 가져온다
